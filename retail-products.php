...
<head>
    <meta charset="utf-8">
    <title>Unit 8 Formatted Content</title>
...
<body>
    ...
    <section>
        ...
        <!-- Below is coded from database using a foreach loop to display the other productBlock -->
        ...
        ?>
            <div class="productBlock">
                ...
                if( $result['product_inStock'] < 10 ) {
                    ?>
                        <p class="productLowInventory"><?php echo $result['product_inStock']; ?></p>
                    <?php
                        //display product inventory is less than 10
                    }
                    ?>
            </div>
        <?php
