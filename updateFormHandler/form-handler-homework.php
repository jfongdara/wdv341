...
<body>
    ...
    <section>
        ...
        <form id="newsletter-form" name="newsletter_form" method="post" action="form-handler.php">
            ...
            <p>
                <label for="subscription">Please Select A Subscription Type</label><br>
                    <input type="radio" id="normal" name="subscription" value="Normal">
                    <label for="normal" name="subscription">Normal</label><br>
                    <input type="radio" id="expert" name="subscription" value="Expert">
                    <label for="expert">Expert</label><br>
            </p>
            <p>
                <label for="offers">Recieve Special Offers And Latest Updates?</label><br>
                <input type="radio" name="offers" value="Yes">
                <label for="yes">Yes</label>
                <input type="radio" name="offers" value="No">
