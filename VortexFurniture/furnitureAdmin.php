...
if( isset($_SESSION['validUser']) && $_SESSION['validUser'] ){
   ...
   header('Location: login.php');
    ...
    try{
        $sql = "SELECT product_id, product_name, product_description, product_price, product_image FROM vortex_product;";
            ...
            <div class="col-md-4 furniture-card-outer">
                <div class="card text-center furniture-card">
                  ...
                  <div class="card-body">
                      ...
                      <Button><?php echo "<p><a href='updateProduct.php?productId=" .  $result['product_id'] . "'>Update Product</a></p>"; ?></Button>
                      <Button><?php echo "<p><a href='deleteProduct.php?productId=" .  $result['product_id'] . "'>Delete Product</a></p>"; ?></Button>
                  </div>
                </div>
            </div>
        </div> 
